...
let obj = {
  ...
  position: `Верстальник, junior Frontend-розробник (наповнення E-магазину)`,
  city: `Київ (вiддалено), Миргород`,
  ...
  language: `Українська-Російська (вільно); Англійська (вище середнього)`,
  main_goal: `Можу почати з наповнення Інтернет-магазину товарами (База даних, Google-таблиці, json/сsv-файли, тощо), або   
              наповнення іншим контентом сайтів`,
  
  desire: `Досвіду участі у комерційних IT-проектах нажаль НЕ маю, але маю ВЕЛИКЕ бажання працювати цій сфері та вчитися i  
           розвиватися. Маю, перелічені віще професійні навички, на рівні Junior Front-end developer. Постійно займаюся самоосвітою за даним напрямком.`,

   thank:  `Виконаю всі тестові завдання – надсилайте, щиро вдячний за розгляд мого резюме`,
   
   skill: [`HTML`, `CSS`, `JavaScript`, `Git`, `Bootstrap`, `Node.js`, `Pug`, `MongoDB`, `MySQL`]
}
